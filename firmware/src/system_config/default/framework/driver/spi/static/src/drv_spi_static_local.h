...
int32_t DRV_SPI2_PolledMasterEBM16BitTasks ( struct DRV_SPI_OBJ * dObj );
int32_t DRV_SPI2_PolledErrorTasks(struct DRV_SPI_OBJ * dObj);
int32_t DRV_SPI2_MasterEBMSend16BitPolled( struct DRV_SPI_OBJ * dObj );
int32_t DRV_SPI2_MasterEBMReceive16BitPolled( struct DRV_SPI_OBJ * dObj );
// DOM-IGNORE-BEGIN
#ifdef __cplusplus
}
#endif
