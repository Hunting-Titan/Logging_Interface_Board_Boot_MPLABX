...
/* Setting for class-2 analog inputs */
    ...
    PLIB_ADCHS_AnalogInputDataReadyInterruptEnable(DRV_ADC_ID_1, ADCHS_AN32);
     PLIB_ADCHS_AnalogInputScanSetup
     (
          DRV_ADC_ID_1, 
          ADCHS_AN32, 
    ...
    PLIB_ADCHS_AnalogInputDataReadyInterruptEnable(DRV_ADC_ID_1, ADCHS_AN40);
     PLIB_ADCHS_AnalogInputScanSetup
     (
          DRV_ADC_ID_1, 
          ADCHS_AN40, 
    ...
    PLIB_ADCHS_AnalogInputDataReadyInterruptEnable(DRV_ADC_ID_1, ADCHS_AN42);
     PLIB_ADCHS_AnalogInputScanSetup
     (
          DRV_ADC_ID_1, 
          ADCHS_AN42, 
